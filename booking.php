	...
	if( tambah($_POST) > 0 ){
		echo "
			<script>
				...
				document.location.href ='surat.php';
			</script>
		";
	}else{
		echo "
...
<body>
	...
	<div class="container">
		...
		<button type="kembali"><a href="kesehatan.php">Kembali</button>
		<p>
		<input type="reset" name="reset" value="Bersihkan">
		<p>
 		<button type="print"> <a href="booking.php" onClick="window.print();">Print/Cetak</button></p>
